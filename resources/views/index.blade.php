...
<html lang="zxx">
    <head>
        ...
        <body>
                ...
                <header>
                    <nav>
                        <div class="container-header">
                            ...
                            <ul class="lista2">
                                <li><button type="submit" class="boton1">Chanelog</button></li>
                                <li><button type="submit" class="boton2">Contact</button></li>
                            </ul>
                        </div>
                    </nav>   
                </header> 
            ...
            <section>
                    <div class="container-documentarion">
                            <div class="col1">
                                <div class="doc">
            ...
            <div class="bcol1"><h1>Bcolumnsse Your Topics</h1></div>
                <div class="grid-container2">
                    <div class="bcol2">
                        <h3>Basic Startup</h3>
                        <p>Crast at dolor eget urna varius faucibus tempus in elit dolor sit amet.</p>
                    </div>
                    <div class="bcol2">
                    <h3>Account Bill</h3>
                        <p>Crast at dolor eget urna varius faucibus tempus in elit dolor sit amet.</p>
